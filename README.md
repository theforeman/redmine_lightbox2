...
**This branch supports Redmine 3.3 only!**

A Redmine 3.4 compatible version can be found in the [master](https://github.com/paginagmbh/redmine_lightbox2/tree/master) branch.
